 ...
 *
 * posunDoleKoniec() - pri uvolneni klavesy DOWN<br />
 * posunHoreKoniec() - pri uvolneni klavesy UP<br />
 * posunVlavoKoniec() - pri uvolneni klavesy LEFT<br />
 * posunVpravoKoniec() - pri uvolneni klavesy RIGHT<br />
 *
 * posunDoleAlt() - pri stlaceni klavesy S<br />
 * posunHoreAlt() - pri stlaceni klavesy W<br />
 * posunVlavoAlt() - pri stlacen klavesy A<br />
 * posunVpravoAlt() - pri stlaceni klavesy D<br />
 *
 * posunDoleAltKoniec() - pri uvolneni klavesy S<br />
 * posunHoreAltKoniec() - pri uvolneni klavesy W<br />
 * posunVlavoAltKoniec() - pri uvolneni klavesy A<br />
 * posunVpravoAltKoniec() - pri uvolneni klavesy D<br />
 *
    ...
    private class ManazerKlaves extends KeyAdapter {
        public void keyPressed(KeyEvent event) {
            if (event.getKeyCode() == KeyEvent.VK_DOWN) {
                ...
                Manazer.this.posliSpravu("posunHoreAlt");
            } else if (event.getKeyCode() == KeyEvent.VK_S) {
                Manazer.this.posliSpravu("posunDoleAlt");
            } else if (event.getKeyCode() == KeyEvent.VK_A) {
                Manazer.this.posliSpravu("posunVlavoAlt");
            } else if (event.getKeyCode() == KeyEvent.VK_D) {
                Manazer.this.posliSpravu("posunVpravoAlt");
            }
        }

        public void keyReleased(KeyEvent event) {
            if (event.getKeyCode() == KeyEvent.VK_DOWN) {
                Manazer.this.posliSpravu("posunDoleKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_UP) {
                Manazer.this.posliSpravu("posunHoreKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_LEFT) {
                Manazer.this.posliSpravu("posunVlavoKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_RIGHT) {
                Manazer.this.posliSpravu("posunVpravoKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_W) {
                Manazer.this.posliSpravu("posunHoreAltKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_S) {
                Manazer.this.posliSpravu("posunDoleAltKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_A) {
                Manazer.this.posliSpravu("posunVlavoAltKoniec");
            } else if (event.getKeyCode() == KeyEvent.VK_D) {
                Manazer.this.posliSpravu("posunVpravoAltKoniec");
            }
        }
    }
